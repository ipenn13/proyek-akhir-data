...
day_df = pd.read_csv("https://raw.githubusercontent.com/ipenn13/proyek-akhir-data/main/day.csv")
hour_df = pd.read_csv("https://raw.githubusercontent.com/ipenn13/proyek-akhir-data/main/hour.csv")
